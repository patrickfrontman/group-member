  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-gray-100">
      <div className="flex md:flex-row shadow-lg rounded-2xl max-w-4xl w-full bg-white">
        ...
        <h1 className='text-3xl font-bold mb-4'>JOIN EPMS</h1>
        <p className='mb-8'>
          join EPMS to streamline yor repairs,track every vehicle,and manage payments in one place.
        </p>
        ...
        <form className='bg-white p-8 rounded-2xl' >
            ...
            <span 
            onClick={()=>setShowpassword(!showpassword)} className='absolute right-3 top-1/3 cursor-pointer text-sm text-gray-300'>
